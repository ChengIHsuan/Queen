...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvQuestion = (TextView) findViewById(R.id.tv_ques);
        tvAnswer0 = (TextView) findViewById(R.id.tv_ans0);
        tvAnswer1 = (TextView) findViewById(R.id.tv_ans1);
        tvAnswer2 = (TextView) findViewById(R.id.tv_ans2);
